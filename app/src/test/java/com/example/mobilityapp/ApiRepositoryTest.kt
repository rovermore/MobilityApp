...
class ApiRepositoryTest {
    ...
    fun setup() = runBlockingTest {
        ...
        whenever(retrofitApiClientImplementation.getResponse()).thenReturn(this@ApiRepositoryTest.transportListResponse)
    ...
    fun `if RetrofitApiClientImplementation return transportList then ApiRepository calls getResponse method returns same transportList`() = runBlockingTest {
        val transportListFromClientImpl = apiRepository.getResponse()
